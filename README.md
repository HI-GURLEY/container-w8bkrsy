...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w8bkrsy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w8bkrsy.containers.anotherwebservice.com/
...
```
git clone git@github.com:HI-GURLEY/container-w8bkrsy.git
cd container-w8bkrsy
```
...
```
docker attach container-w8bkrsy
```
